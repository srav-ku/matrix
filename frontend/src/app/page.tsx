      ...
      <main className="flex flex-col items-center justify-center px-4 py-20">
        ...
        <div className="max-w-4xl mx-auto mt-32 px-4">
          <div className="bg-gray-900/50 border border-gray-700 rounded-2xl p-8">
            ...
            <p className="text-gray-300 mb-6">Get started with the Movie API in minutes:</p>
            
            <div className="bg-black border border-gray-800 rounded-lg p-4 font-mono text-sm mb-6">
            ...
            <div className="flex gap-4">
              <Link href="/documentation" className="bg-green-500 hover:bg-green-400 text-black px-6 py-2 rounded-lg font-medium transition-colors">
                View Documentation
              </Link>
              <Link href="/auth" className="bg-gray-700 hover:bg-gray-600 text-white px-6 py-2 rounded-lg font-medium transition-colors">
                Get API Key
              </Link>
            </div>
          </div>
